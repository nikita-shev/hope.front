...
import s from '@components/icons/components/CartIcon/CartIcon.module.sass';

export function CartIcon(): ReactElement {
    const title: string = 'Добавить товар в корзину';
    ...
    return (
        ...
        >
            ...
            <g>
                <path d="M78.489,43.552H46.612c-0.997,0-1.804-0.808-1.804-1.804c0-0.997,0.808-1.804,1.804-1.804h31.877c0.997,0,1.804,0.808,1.804,1.804C80.293,42.744,79.486,43.552,78.489,43.552z" />
            </g>
            <g>
                <path d="M76.051,52.574H49.864c-0.996,0-1.804-0.808-1.804-1.804c0-0.997,0.808-1.804,1.804-1.804h26.188c0.997,0,1.804,0.808,1.804,1.804C77.855,51.766,77.048,52.574,76.051,52.574z" />
            </g>
        </svg>
    );
}
